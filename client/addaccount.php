...
<div class="appHeader1">
  <div class="left"> <a href="/manage_bankcard.php" onClick="goBack();" class="icon goBack"> <i class="icon ion-md-arrow-back"></i> </a>
...
<div id="appCapsule">
 ...
 <div class="form-group ">
      ...
      <input type="number" class="form-control textarea " id="mobile" name="mobile" maxlength="10" required value="">
      </div>
...
<div class="appBottomMenu">
  ...
  <div class="item "> <a href="search.php">
    ...
    </div><div id="alert" class="modal fade" role="dialog">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-body" id="alertmessage"> </div>
      <div class="text-center pb-1">
     <a type="button" class="text-info" data-dismiss="modal"><a href="manage_bankcard.php" style="colour: black;">OK</a></a>
    </div> 
    </div>
  </div>
</div>
