...
<body>
    ...
    <div id="main-wrapper" class="oxyy-login-register bg-light">
        <div class="container">
            <div class="row">
                    ...
                    <div class="container user-space">
                        <div class="row">
                            <div class="img-logo" style="margin-top: -170px!important;">
                                <center><img
                                        src="https://apksos.com/storage/images/com/predictor_aviator/Reference/com.predictor_aviator.Reference_1.png"
                                        class="logo1" style="height: 200px;width: 200px;"></center>
                            </div>
                            <div class="col-10 col-lg-10 mx-auto" style="margin-top: -200px!important;">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <a href="login.php">
                                            <li class="breadcrumb-item active page-heading" aria-current="page"><i
                                                    class="fa fa-sign-in yellow-text"
                                                    aria-hidden="true"></i>&nbsp;&nbsp;Register</li>
                                        </a>
                                    </ol>
                                </nav>

                                <form  class="form-dark" name="form" id="form" action="register.php" method="POST">
                                    ...
                                    <div class="d-grid my-4">
                                        <button class="btn btn-light padding-10"
                                            style="background-color: rgb(221, 23, 23);color:white;border: 0;"
                                            type="submit" name="submit" id="submit">REGISTER</button>
                                    </div>
                                </form>
                                ...
                                <p class="text-center">Allready Login? <a href="login.php
