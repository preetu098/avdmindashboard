              ...
              <form id="formID" name="formID" method="post" action="#" enctype="multipart/form-data">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    $sql = "select * from withdraw_details where status=2 ";
                    ...
                    if (mysqli_num_rows($result) > 0) {
                      while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                          ...
                          <td></td>
                          <td><a href="withdrawal-accept-reject.php?id=bTM4bENCRXQwYVpkYXQ1RjFoUytmZz09" data-toggle="tooltip"
                          ...
                          <td> <a class="btn btn-danger"
                              href="delete_withdraw_record.php?id=<?php echo $row['id'] ?>&user_id=<?php echo $row['user_id']; ?>">Delete</a>
                          </td>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 text-right">
                    <strong>Total Request Amount: <i class="red_txt"><?php
